// src/app/page.tsx - Simplified version with fixed props
'use client';
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPreview.map((plan, index) => (
              <Card key={index} className={`relative text-center ${
                ...
                <Link 
                  href="/pricing"
                  className={`w-full py-2 px-4 rounded-lg font-semibold transition-colors inline-block ${
                    plan.popular 
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link href="/api-docs" className="text-gray-400 hover:text-white block">API Docs</Link>
                <Link href="/dashboard" className="text-gray-400 hover:text-white block">Dashboard</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link href="/api-docs" className="text-gray-400 hover:text-white block">Documentation</Link>
                <Link href="/contact" className="text-gray-400 hover:text-white block">Help Center</Link>
                <Link href="/contact" className="text-gray-400 hover:text-white block">Contact Support</Link>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 MataOCR. All rights reserved. Built with ❤️ in Malaysia.
            </p>
          </div>
        </div>
      </footer>
